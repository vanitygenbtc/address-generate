...
var tokenSchemaBasic = function tokenSchemaBasic(_ref) {
   ...
   // if (gas) gasBlock = '[?gas=' + gas + ']';
    if (value) valueBlock = '?amount=' + value;

    return 'bitcoin:' + to + gasBlock + valueBlock;
};
/**
 * generate string: bitcoin:${to}${gasBlock}${valueBlock}${gasBlock}`
 * @param {*} param0 
 */
var tokenSchemaFunction = function tokenSchemaFunction(_ref2) {
   ...
   // if (gas) gasBlock = '[?gas=' + gas + ']';
    ...
    return 'bitcoin:' + to + gasBlock + valueBlock + gasBlock + functionBlock;
};
...
var tokenSchemaContract = function tokenSchemaContract(_ref3) {
    ...
    return 'bitcoin:' + to + gasBlock + contractBlock;
};
